  ...
  calculateMetrics: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      return {
        ...
        totalActualExpenses: parseFloat((metrics.totalActualExpenses ?? 0).toString()),
        totalDuplicatedActualExpenses: parseFloat((metrics.totalDuplicatedActualExpenses ?? 0).toString()),
        ...
        budgetStatus: metrics.budgetStatus ?? metrics.status,
        expenseItems: metrics.expenseItems ?? [],
        importedActualExpenses: metrics.importedActualExpenses ?? [],
        ignoredDuplicateExpenses: metrics.ignoredDuplicateExpenses ?? [],
      };
    }),
  ...
  getMetrics: protectedProcedure
    ...
    .query(async ({ input }) => {
      ...
      return {
        ...
        totalActualExpenses: parseFloat((calc.totalActualExpenses ?? 0).toString()),
        totalDuplicatedActualExpenses: parseFloat((calc.totalDuplicatedActualExpenses ?? 0).toString()),
        ...
        budgetStatus: calc.budgetStatus ?? calc.status,
        expenseItems: calc.expenseItems ?? [],
        importedActualExpenses: calc.importedActualExpenses ?? [],
        ignoredDuplicateExpenses: calc.ignoredDuplicateExpenses ?? [],
      };
    }),
});
