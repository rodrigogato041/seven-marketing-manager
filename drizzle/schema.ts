...
export const tasks = mysqlTable("tasks", {
  ...
  taskType: mysqlEnum("taskType", [
    ...
    "capture",
    "planning",
  ]).default("administrative").notNull(),
  checklist: text("checklist"),
  recurrence: mysqlEnum("taskRecurrence", ["none", "daily", "weekly", "biweekly", "monthly", "custom"]).default("none").notNull(),
  recurrenceEvery: int("recurrenceEvery").default(1),
  recurrenceUntil: bigint("recurrenceUntil", { mode: "number" }),
  recurrenceParentId: int("recurrenceParentId"),
  recurrenceLastGeneratedAt: bigint("recurrenceLastGeneratedAt", { mode: "number" }),
  comments: text("comments"),
  history: text("history"),
  relatedLinks: text("relatedLinks"),
  attachmentLinks: text("attachmentLinks"),
